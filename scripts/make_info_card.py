...
# ===========================================================================
HOST = "DSBaibhav"   # shown as  DSBaibhav@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role",      "Full-Stack & Blockchain Dev"),
    ("kv", "Edu",       "B.Tech CSIT, Narula Inst of Tech '28"),
    ("kv", "CGPA",      "8.5 / 10 (latest)"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C, Python, JavaScript, Java"),
    ("kv", "Web Dev",   "React, Next.js, Django, HTML5/CSS3"),
    ("kv", "Web3",      "Stellar Blockchain, Smart Contracts"),
    ("kv", "AI / ML",   "PyTorch, LangChain, OpenAI, GenAI"),
    ("kv", "Tools",     "Git, Docker, MongoDB, Postman"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Won Catalyst 2k26 Hackathon (FinTech Track)"),
    ("bul", "Built BondChain: Tokenized Bond Platform (RWA)"),
    ("bul", "Developed InvoiceFin Invoice Financing Platform"),
]
