...
ROWS = [
    ("host",),
    ("kv", "Role",    "Software Developer"),
    ("kv", "Intern",  "Software Dev Intern @ NIT Durgapur"),
    ("kv", "Edu",     "B.Tech CSE, NIT Durgapur '26"),
    ("kv", "CGPA",    "8.3 / 10"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript, Tailwind"),
    ("kv", "Backend",  "Node.js, Django, FastAPI, PostgreSQL"),
    ("kv", "AI / ML",  "PyTorch, LangChain, OpenAI, HuggingFace"),
    ("kv", "Cloud",    "AWS, Docker, GitHub Actions, Vercel"),
    ("kv", "Other",    "Solidity, Blockchain, REST, GraphQL"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built Blockchain-based KYC system (BCT project)"),
    ("bul", "GSoC mentor outreach — contributed to R ecosystem"),
    ("bul", "Led team at Hack-o-NIT hackathon"),
    ("bul", "Open to SWE intern / full-time roles — 2026"),
]
